...
/**
 * Repository interface for managing {@link PolicyAttributeScope} entities.
 ...
 * query methods specific to {@link PolicyAttributeScope}.
 */
@Repository
public interface PolicyAttributeScopeRepository extends JpaRepository<PolicyAttributeScope, Long> {

    Optional<PolicyAttributeScope> findByCode(String code);
}
