...
/**
 * A policy attribute resolved from the {@code attribute_scope}/{@code attribute_definition}/
 * {@code attribute_value} schema (added by PR #69) - the same three fields as {@link
